...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide" id="main-heading">
        Your Partner in
      ...
      <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl' id="hero-description">
      ...
      <div className='flex mt-10 justify-center'>
        <video autoPlay loop muted className='rounded-lg w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4' aria-label="Showcase of Otical web development projects">
          <source src={video1} type='video/mp4' />
          Your Browser does not support the video tag
        </video>
        <video autoPlay loop muted className='rounded-lg w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4' aria-label="Showcase of Otical AI innovation projects">
